...
Encore
    ...
    // Avoids an infinite rebuild loop in Docker/WSL2: without this, the watcher
    // sees its own writes to public/build/ as file changes and rebuilds forever.
